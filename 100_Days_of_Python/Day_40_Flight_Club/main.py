...
"""Populating Google Sheet IATA codes wrt city names (Uses Sheetly requests quota!)"""
...
# if email == confirm_email: data_manager.save_users_data(first_name, last_name, email)
